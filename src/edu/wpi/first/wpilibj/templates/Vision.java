...
public class Vision {
    ...
    private Vision() {
        ...
        //cc.addCriteria(MeasurementType.IMAQ_MT_AVERAGE_HORIZ_SEGMENT_LENGTH, 20, 320, false);
    }

    public boolean findHorizontalTargets() throws AxisCameraException {
        TargetReport target = new TargetReport();
        int verticalTargets[] = new int[MAX_PARTICLES];
        int horizontalTargets[] = new int[MAX_PARTICLES];
        int verticalTargetCount, horizontalTargetCount;

        boolean horizontalTargetFound = false;
        ...
        try {
            ...
            //image.write("/realImage.bmp");
            //BinaryImage thresholdImage = image.thresholdHSV(105, 137, 230, 255, 70, 183);   // keep only green objects
            //thresholdImage = image.thresholdHSV(105, 137, 130, 255, 70, 183);   // keep only green objects
            thresholdImage = image.thresholdHSV(100, 150, 120, 255, 50, 200);   // keep only green objects
            ...
            System.out.println("Threshold image num particles: " + thresholdImage.getNumberParticles());
            System.out.println("FilteredImage num particles:" + filteredImage.getNumberParticles());
